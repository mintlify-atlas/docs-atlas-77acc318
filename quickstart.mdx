...
```bash
git clone https://github.com/your-username/deltarune-transcript-dataset.git
cd deltarune-transcript-dataset
```
...
1    Scene: Cyber World    Susie             Hell yeah!!!
2    Scene: Cyber World     Kris  ...
```
...
Each record in this file uses the standard ChatML structure:

```json chatml example
{"messages": [
  {"role": "system", "content": "Scene: Cyber World"},
  {"role": "assistant", "content": "Susie: Hell yeah!!!"}
]}
```
